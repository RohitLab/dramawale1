...
const LEVELS = [
  {
    ...
    outcome:
      "Graduate with a Dramawale Foundation Certificate and the confidence to perform on any stage.",
  },
  {
    icon: Zap,
    level: "Level 02",
    ...
    outcome:
      "Earn the Advanced Acting Certification and access our exclusive placement network for schools and productions.",
  },
  {
    icon: Crown,
    level: "Level 03",
    ...
    outcome:
      "Complete Dramawale's highest honour — Actor's Siddhi — and qualify for our Certified Drama Educator (CDE) pathway.",
  },
];
                  ...
                  <div className="bg-white rounded-2xl border border-[#E2D8CC] overflow-hidden shadow-sm hover:shadow-lg transition-shadow">
                    <div className="grid lg:grid-cols-5 gap-0">
                      ...
                      <div className="lg:col-span-3 p-8 lg:p-10">
                        <h3 className="font-semibold text-[#1C1C1C] mb-4 text-sm uppercase tracking-widest">
                        ...
                        <div className="bg-[#FAF6F0] rounded-xl p-4 border border-[#E2D8CC]">
                          <p className="text-sm font-semibold text-[#7C1D2F] mb-1">
                            Programme Outcome
                          </p>
