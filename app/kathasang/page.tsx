...
export const metadata: Metadata = {
  ...
  keywords: ["drama for underprivileged children", "KATHASANG fellowship", "theatre social impact India"],
  openGraph: {
    title: "KATHASANG — Drama Fellowship for Underprivileged Children",
    description: "Bringing theatre and drama to underprivileged children across India. 500+ children reached in 8 states.",
...
const TESTIMONIALS = [
  {
    ...
    quote: "My daughter used to be so shy she wouldn't look up in class. After six weeks of KATHASANG, she performed on a stage in front of hundreds of people. I cried happy tears.",
  },
  {
    name: "Rakesh Kumar",
    role: "Village Teacher, Jharkhand",
    quote: "KATHASANG didn't just teach drama. It taught our children that their stories matter, their voices matter. That is education no textbook can give.",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <AnimatedSection direction="left">
              ...
              <p className="text-[#4A4A4A] leading-relaxed mb-4">
                In rural communities, tribal hamlets, and urban slums across India, thousands of children
                are denied access to the arts. KATHASANG exists to change that — one story at a time.
              </p>
              <p className="text-[#4A4A4A] leading-relaxed mb-4">
                Our volunteer educators spend weeks embedded in communities, running daily drama workshops,
                storytelling circles, and performance rehearsals.
              </p>
              <p className="text-[#4A4A4A] leading-relaxed">
                The programme culminates in a community performance — a moment of joy, pride, and visibility
                for children who are too often invisible.
              </p>
            </AnimatedSection>
