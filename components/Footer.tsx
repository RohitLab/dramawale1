        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-9 h-9 rounded-full bg-[#A63245] flex items-center justify-center">
                <span className="text-white font-bold text-sm font-display">D</span>
              </div>
              <span className="font-display font-bold text-white text-xl">Dramawale</span>
            </div>
            ...
            <p className="text-[#C4623A] text-xs font-semibold uppercase tracking-widest">
          ...
          {/* Platform links */}
          <div>
            <h4 className="text-sm font-semibold text-white/90 uppercase tracking-widest mb-5">
              Platform
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2.5 text-sm text-white/60">
                <MapPin className="w-4 h-4 mt-0.5 text-[#C4623A] flex-shrink-0" />
              ...
              <li>
                ...
                >
                  <Mail className="w-4 h-4 text-[#C4623A] flex-shrink-0" />
                  {CONTACT_INFO.email}
                </a>
              </li>
              <li>
                <a
                  ...
                  className="flex items-center gap-2.5 text-sm text-white/60 hover:text-white transition-colors"
                >
                  <Phone className="w-4 h-4 text-[#C4623A] flex-shrink-0" />
                  {CONTACT_INFO.phone}
                </a>
              </li>
            </ul>
            <a
              ...
              className="mt-5 inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5a] text-white text-sm font-semibold px-4 py-2.5 rounded-full transition-colors"
            >
